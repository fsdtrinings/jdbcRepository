...
public class EmployeeDAOImpl implements IEmployeeDAO {
	...
	String insertEmployeeQuery = "insert into fisapp.employee values(?,?,?)";
	String selectAllEmployees = "select * from fisapp.employee";
	String selectEmployeeBasedOnID = "select * from fisapp.employee where idEmployee = ?";
